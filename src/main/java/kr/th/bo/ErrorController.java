...
public class ErrorController {
	...
	@RequestMapping(value = "/408",method = {RequestMethod.GET,RequestMethod.POST})
	public String pageError408( Model model) {
		model.addAttribute("errorCode","요청시간 초과");
		model.addAttribute("errorMsg","서버의 요청 시간을 초과하였습니다.");
		return "/error";
	}
}
